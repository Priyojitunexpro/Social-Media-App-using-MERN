...
import { UserContext } from '../App'//the file to store object asssociated with delete account//the file to store object asssociated with delete account
...
import '../App.css'//the file to store object asssociated with delete account//the file to store object asssociated with delete account
...
const Navbar = () => {
  ...
  const renderList = () => {//the file to store object asssociated with delete account
    if (state) {
      return [
  ...
  return (
    <nav className="navbar">
      <div className="nav-wrapper white">
        <Link to={state ? "/" : "/signin"} className="brand-logo left">BD-WT Reels</Link>
