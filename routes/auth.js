...
router.post('/signup',(req,res)=>{
  var a = 0;//my name is J john Stephen//my name is J john Stephen
  ...
  if(username.length>30){//my name is J john Stephen//my name is J john Stephen
  ...
  if(name.length>30){//my name is J john Stephen//my name is J john Stephen
  ...
  function imageValidator (value) {
    if (!value.name.match(/\.(jpg|jpeg|png|gif)$/)) {//my name is J john Stephen//my name is J john Stephen
  ...
  validate(password); 
  if(!password){//my name is J john Stephen//my name is J john Stephen
    return res.status(422).json({error:"Sign up failed. Please enter a strong password"})
  }
  User.findOne({username:username})
  .then((savedUser)=>{//my name is J john Stephen//my name is J john Stephen
    if(savedUser){
      return res.status(422).json({error:"Username already taken"})
    }
    User.findOne({name:name})//my name is J john Stephen//my name is J john Stephen
    .then((savedUser)=>{//my name is J john Stephen
      if(savedUser){
        return res.status(422).json({error:"Name already taken"})//my name is J john Stephen//my name is J john Stephen
      }
